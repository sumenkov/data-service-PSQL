...
public class InitRepositoryImpl implements InitRepository {
    ...
    private static final String QUERY_INIT_PRODUCTS =
            "CREATE TABLE PRODUCTS (ID SERIAL PRIMARY KEY, NAME TEXT, PRICE NUMERIC(9, 2));" +
                    ...
                    "INSERT INTO PRODUCTS (NAME, PRICE) VALUES ('Яблоко', 135.25);" +
    ...
    private static final String QUERY_INIT_PURCHASES =
            "CREATE TABLE PURCHASES (ID SERIAL PRIMARY KEY, BUYER_ID INTEGER, PRODUCT_ID INTEGER, " +
                    "FOREIGN KEY (BUYER_ID) REFERENCES BUYERS(ID), FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCTS(ID)," +
                    "DATE_OF_PURCHASE DATE);" +
                    "INSERT INTO PURCHASES (BUYER_ID, PRODUCT_ID, DATE_OF_PURCHASE) VALUES (3, 3, '2022-10-21');" +
                    "INSERT INTO PURCHASES (BUYER_ID, PRODUCT_ID, DATE_OF_PURCHASE) VALUES (1, 2, '2022-11-01');" +
                    "INSERT INTO PURCHASES (BUYER_ID, PRODUCT_ID, DATE_OF_PURCHASE) VALUES (4, 1, '2022-11-05');" +
                    "INSERT INTO PURCHASES (BUYER_ID, PRODUCT_ID, DATE_OF_PURCHASE) VALUES (3, 3, '2022-10-21');" +
                    "INSERT INTO PURCHASES (BUYER_ID, PRODUCT_ID, DATE_OF_PURCHASE) VALUES (2, 2, '2022-10-21');" +
                    "INSERT INTO PURCHASES (BUYER_ID, PRODUCT_ID, DATE_OF_PURCHASE) VALUES (3, 4, '2022-10-21');";
